package com.toastexample.share;
...
public class ShareExtensionModule extends ReactContextBaseJavaModule implements ActivityEventListener {
  ...
  public ShareExtensionModule(ReactApplicationContext reactContext) {
    super(reactContext);
  ...
  public String getName() {
    return "ShareExtensionComponent";
  }
